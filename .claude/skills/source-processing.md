...
# Source Processing (Claude Mirror)

This skill references the universal version. See [skills/source-processing.md](../../skills/source-processing.md) for the full procedure.
