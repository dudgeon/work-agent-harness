...
# Agent Control & Mirror Sync (Windsurf Mirror)

This skill references the universal version. See [skills/agent-control-mirror-sync.md](../../skills/agent-control-mirror-sync.md) for the full procedure.
