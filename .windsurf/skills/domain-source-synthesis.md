...
# Domain Source Synthesis (Windsurf Mirror)

This skill references the universal version. See [skills/domain-source-synthesis.md](../../skills/domain-source-synthesis.md) for the full procedure.
